...
> **NexoCLI_BaseGemini** é um fork avançado e extensível do [Gemini-CLI](https://github.com/google-gemini/gemini-cli) da Google LLC, adaptado e melhorado para suporte multi-provider (Gemini, OpenRouter, Ollama/local), rotação e fallback automático, e documentação de personalidade/instruções estáticas do agente.
