...
**NexoCLI_BaseGemini** é um fork avançado do projeto open-source Gemini-CLI (Google LLC), licenciado sob Apache License 2.0. Este documento define as regras de compliance, desenvolvimento, atribuição e documentação obrigatória para todos os agentes (humanos ou IA) que contribuam para este repositório.
